    ...
    var t = {
            ...
            5948: (t, r, e) => {
                ...
                O || (n = function () {
                    ...
                    i = void 0, t && t.enter()
                }, d || b || m || !g || !x ? !y && S && S.resolve ? ((s = S.resolve(void 0)).constructor = S, f = v(s.then, s), a = function () {
                    f(n)
                }) : b ? a = function () {
                    w.nextTick(n)
                } : (h = v(h, p), a = function () {
            ...
            261: (t, r, e) => {
                ...
                g && x || (g = function (t) {
                    ...
                    S.now(F(t))
                } : O && !m ? (a = (i = new O).port2, i.port1.onmessage = M, o = s(a.postMessage, a)) : u.addEventListener && f(u.postMessage) && !u.importScripts && n && "file:" !== n.protocol && !v(k) ? (o = k, u.addEventListener("message", M, !1)) : o = L in d("script") ? function (t) {
            ...
            8674: (t, r, e) => {
                ...
                var n, o, i, a, u = e(2109),
                    ...
                    et = D(V, (function () {
                        ...
                        return (e.constructor = {})[G] = n, !(rt = e.then((function () {})) instanceof n) || !r && C && !Z
                    })),
                    nt = et || !O((function (t) {
                    ...
                    ct = function (t) {
                        p(T, s, (function () {
                            ...
                            if (st(t) && (r = M((function () {
                                ...
                                })), t.rejection = I || st(t) ? 2 : 1, r.error)) throw r.value
                        }))
                    },
                    st = function (t) {
                    ...
                    ft = function (t) {
                        p(T, s, (function () {
                            var r = t.facade;
                            I ? $.emit("rejectionHandled", r) : ut("rejectionhandled", r, t.value)
                        }))
                    },
                    pt = function (t, r, e) {
                        return function (n) {
                ...
                if (et && (B = (W = function (t) {
                        ...
                        then: function (t, r) {
                            var e = H(this),
                                n = X(E(this, W));
                            return e.parent = !0, n.ok = !g(t) || t, n.fail = g(r) && r, n.domain = I ? $.domain : void 0, 0 == e.state ? e.reactions.add(n) : P((function () {
                                it(n, e)
                            })), n.promise
                        },
                        catch: function (t) {
    ...
    (() => {
        ...
        var u = a((function t(r) {
            ...
            f = function (r, e, n, i) {
                ...
                return s.append("lib_version", "3.6.2"), s.append("service_id", r), s.append("template_id", e), s.append("user_id", a), c("/api/v1.0/email/send-form", s)
            };
        const p = {
            init: r,
            send: s,
